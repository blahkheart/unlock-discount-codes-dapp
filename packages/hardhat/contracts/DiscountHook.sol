...
contract DiscountHook is Ownable {
    ...
    function deleteDiscountForLock(address lock, address signer) public {
        bool isManager = IPublicLockV12(lock).isLockManager(msg.sender);
        require(isManager, "Not Manager");
        delete discounts[lock][signer];
    }
